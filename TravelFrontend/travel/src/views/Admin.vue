<template>
  <div>
    <v-container fluid class="my-2">
        ...
        <v-menu bottom min-width="150px" rounded offset-y>
          <template v-slot:activator="{ on }">
            <v-btn icon x-large v-on="on">
              <v-avatar color="purple darken-4" size="48">
      ...
      <v-btn block class="my-3" @click="list"> List The Users </v-btn>
            ...
            <v-container>
              <v-row>
                ...
                <v-col cols="12">
                  <v-text-field
                    label="UserAddress"
                    v-model="selectedUser.userAddress"
                  ></v-text-field>
                </v-col>
                <v-col cols="12">
                  <v-text-field
                    label="UserFavorite"
                    v-model="selectedUser.userFavorite"
                  ></v-text-field>
                </v-col>
                <v-col cols="12">
                  <v-text-field
                    label="UserAdmin"
                    v-model="selectedUser.userAdmin"
                  ></v-text-field>
                </v-col>
              </v-row>
            </v-container>
